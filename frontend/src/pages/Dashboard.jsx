...
const Dashboard = () => {
  ...
  return (
    <div className="w-full h-screen flex bg-white">
      {/* Left sidebar */}
      <div className="w-28 h-full bg-zinc-900 flex flex-col items-center justify-between py-10">
        ...
        <div className="flex flex-col items-center space-y-10">
          ...
          <div 
            ...
            className="w-20 h-20 flex items-center justify-center cursor-pointer hover:bg-gray-900"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 text-neutral-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
